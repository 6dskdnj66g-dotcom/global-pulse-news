...
const NewsCard: React.FC<NewsCardProps> = ({ article }) => {
    ...
    return (
        <Tilt
            ...
            className="h-full"
        >
            <Link to={`/article/${article.id}`} className="group block h-full bg-paper dark:bg-zinc-900 border border-black/5 dark:border-white/5 hover:border-black/20 dark:hover:border-white/20 transition-all duration-500 hover:shadow-xl relative overflow-hidden">
